...
public class SongLoader {
	...
	public static Song parseSong(String songString) throws InvalidSongFormatException {
		...
		try{
			...
			throw new InvalidSongFormatException("Invalid rating format");		
		}catch(Exception e){
			throw new InvalidSongFormatException("failed to parse song bruh");		
		}finally{
			s.close();
		}
	}
	...
	public static ArrayList<String> parseInstrumentsList(String instruments) {
		ArrayList<String> instrumentArrayList = new ArrayList<String>();
		String[] myArray = instruments.split(",");
		for (String s : myArray) {
  			instrumentArrayList.add(s);
		}
